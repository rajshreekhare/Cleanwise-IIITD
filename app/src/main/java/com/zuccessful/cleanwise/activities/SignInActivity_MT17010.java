...
public class SignInActivity_MT17010 extends AppCompatActivity {
    private static final String TAG = SignInActivity_MT17010.class.getSimpleName();
        ...
        signInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isConnected && isSync) {
                    ...
                    Toast.makeText(SignInActivity_MT17010.this, "Syncing... Please wait for a few moments...", Toast.LENGTH_SHORT).show();
                    showProgressDialog("Syncing... Please wait for a few moments...");
                } else
                    Toast.makeText(SignInActivity_MT17010.this, "Please connect to internet...", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    protected void onResume() {
        ...
        if (!isConnected) {
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SignInActivity_MT17010.this);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignInActivity_MT17010.this, "Some Error Occurred", Toast.LENGTH_SHORT).show();
...
//            Toast.makeText(this, "Email: " + currentUser.getEmail(), Toast.LENGTH_LONG).show();
            if (currentUser.getEmail() != null && currentUser.getEmail().endsWith("@iiitd.ac.in")) {
                ...
                Supervisor_MT17010 s = new Supervisor_MT17010(Utilities_MT17010.getUserKey(currentUser.getEmail()), currentUser.getEmail(), currentUser.getDisplayName(), FirebaseInstanceId.getInstance().getToken());
...
//            Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
            if (access) {
                ...
                Toast.makeText(this, "Sign-in with Supervisor_MT17010 Account at IIITD", Toast.LENGTH_SHORT).show();
                signOut();
            }
        }
    }
