...
public class Supervisor_MT17010 {
    private String id;
    ...
    public Supervisor_MT17010() {
        this.deviceTokens = new ArrayList<>();
        this.jobIds = new ArrayList<>();
    }

    public Supervisor_MT17010(String id, String emailId, String name, ArrayList<String> deviceTokens) {
        this.id = id;
    ...
    public Supervisor_MT17010(String id, String emailId, String name, String deviceToken) {
        this.id = id;
        this.emailId = emailId;
        this.name = name;
        this.jobIds = new ArrayList<>();
