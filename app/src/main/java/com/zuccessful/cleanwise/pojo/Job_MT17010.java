...
public class Job_MT17010 {
    ...
    public Job_MT17010(String id, String washroomId, String supervisorId, long timestamp, int slot, HashMap<String, Boolean> checklist, ArrayList<String> images) {
        this.id = id;
